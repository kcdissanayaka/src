            ...
            <div class="col">
                <header class="header">
                    ...
                    <nav class="navbar navbar-expand-md">
                        ...
                        <li><a href="index.php">Exercise7 Create Data</a></li>
                        <li><a href="updatesingle.php">Exercise7 Reead data</a></li>
                        <li><a href="deletesingle.php">Exercise7 Delete data</a></li>
                       ...
                       <li class="hideOnMobile"><a href="index.php">Exercise7 Create Data</a></li>
                        <li class="hideOnMobile"><a href="read.php">Exercise7 Reead Data</a></li>
                        <li class="hideOnMobile"><a href="updatesingle.php">Exercise7 Update Data</a></li>
                        <li><a href="deletesingle.php">Exercise7 Delete data</a></li>
